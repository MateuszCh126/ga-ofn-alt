...
def plot(
    ...
    # zbieramy kontur: ramię wznoszące (y od 0 do 1) + opadające (y od 1 do 0)
...
def plot_arithmetic(
    ...
    """
    Trójpanelowy wykres: A | B | wynik operacji
...
def plot_direction_demo(
    ...
    """
    Demonstruje różnicę między OFN skierowaną w prawo i w lewo dla tego samego kształtu.
    """
    _require_mpl()
    ...
    plot(a, label="OFN w prawo", color=_COLORS[0], ax=axes[0], title="Skierowanie: w prawo")
    plot(b, label="OFN w lewo", color=_COLORS[1], ax=axes[1], title="Skierowanie: w lewo")
